...
#from blueprints.backend.model.busses.models import Bus
#from blueprints.backend.model.repairs.models import Repair
...
#from blueprints.backend.form.repairs.forms import RepairForm
...
from blueprints.backend.form.schedules.forms import ScheduleForm
...
def reservations_index():
    ...
    if form.validate_on_submit():
        ...
        reservations = Reservation.query.filter(or_(
            Reservation.amount.like('%'+search+'%'),
            Reservation.passenger_id.like('%'+search+'%'))).all()
...
def reservations_create():
    ...
    return render_template('reservations/create.html',form=form,users=users,schedules=schedules,bus=bus)    
...
def reservations_edit(id):
    ...
    return render_template('reservations/edit.html',form=form, reservations=reservations,schedules=schedules,users=users,bus=bus)
